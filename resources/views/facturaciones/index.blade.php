...
@section('main-content')
    ...
    <div class="col-xs-12">
        ...
        <button type="button" class="btn btn-default" title="Hacer click aquí para exportar los datos de clientes adeudados a formato Excel.">
            <a href="{{ url('descargarAdeudados') }}" style="text-decoration: none;"> <span class="text-muted"> <i class="icon-file"></i> .EXCEL</span></a>
        </button>
    </div>
